...
class InCoScoreCalculator:
    ...
    def _calculate_research_score(self, user):
        ...
        for paper in papers:
            ...
            verify_bonus = 1.1 if paper.verified else 1.0
            score += venue_score * decay * verify_bonus
    ...
    def _calculate_projects_score(self, user):
        ...
        for project in projects:
            ...
            verify_bonus = 1.1 if project.verified else 1.0
            score += complexity * verify_bonus
    ...
    def _calculate_hackathon_score(self, user):
        ...
        for hackathon in hackathons:
            ...
            verify_bonus = 1.1 if hackathon.verified else 1.0
            score += base_points * decay * verify_bonus
    ...
    def _calculate_internship_score(self, user):
        ...
        for internship in internships:
            ...
            verify_bonus = 1.1 if internship.verified else 1.0
            score += base_points * decay * verify_bonus
    ...
    def _calculate_certification_score(self, user):
        ...
        for cert in certifications:
            ...
            verify_bonus = 1.1 if cert.verified else 1.0
            score += difficulty_score * decay * verify_bonus
